...
def extract(args):
    if args.Methord == 'Consolidated':
        return consolid()
    elif args.Methord == 'Individual':
        return indivi()
    else:
        print('')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='> Choose a format for data extraction: \n  1.Consolidated\n  2.Individual Files')
    parser.add_argument("Extract", type=str, help="Operation")
    parser.add_argument("Methord", type=str,
                        default='consolid()', help="Consolidated /Individual")
